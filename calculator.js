...
function bs()
{
 document.lcdform.lcds.value=document.lcdform.lcds.value.slice(0,document.lcdform.lcds.value.length-1);
}

function dis(x)
{
document.lcdform.lcds.value=document.lcdform.lcds.value+x;
